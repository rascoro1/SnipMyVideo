...
github_user = 'rascoro1'
author = 'rascoro1'
author_email = ''
description = 'Snip or cut a segment and render a subclip of a video clip'
# ------------------------------------------------------------- #
...
module_name = 'snip_my_video'
github_url = 'https://github.com/{}/{}'.format(github_user, 'SnipMyVideo')
...
setup(use_scm_version={'root': directory},
      ...
      url=github_url,
      keywords=[],
      entry_points={'console_scripts': ['snip=snip_my_video.__main__:run']},
